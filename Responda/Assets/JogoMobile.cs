...
public class JogoMobile : MonoBehaviour
{
    ...
    public Text[] alternativas_botao_texto = new Text[4];
    ...
    public Button alternativa1_botao;
    public Button alternativa2_botao;
    public Button alternativa3_botao;
    public Button alternativa4_botao;
    ...
    private void SortearPerguntas()
    {
        ...
        for(int i = 0; i < CarregaDados.listaDados.Count; i++)
        {
            if(CarregaDados.listaDados[i].nivel == "facil"){
                ...
                CarregaDados.listaDados[i].audio_dica = "pd" + (i - quantidade_facil - quantidade_medio);
                for(int j = 0; j < 4; j++){
    ...
    public void TocarHighlight(int alternativa)
    {
        if(alternativa == 0){
            audio_a0.Play();
            alternativa1_botao.Select();
        }
        else if (alternativa == 1){
            audio_a1.Play();
            alternativa2_botao.Select();
        }
        else if (alternativa == 2){
            audio_a2.Play();
            alternativa3_botao.Select();
        }
        else if (alternativa == 3){
            audio_a3.Play();
            alternativa4_botao.Select();
        }
    }
    ...
    private void CriarJanelaErrado ()
    {
        botao_panel.Select();
        Panel_anim.SetBool("showPanel", true);
        panel_title.text = "RESPOSTA ERRADA !";
        panel_text.text = "Você ganhou ZERO pontos.";
    }
    ...
    private void ExibirCertoOuErrado()
    {
        ...
        {
            audio_transicoes.clip = Resources.Load<AudioClip>("audio/Resposta_errada");
            audio_transicoes.Play();
            showErrado = true;
            CriarJanelaErrado();
        }
    }
